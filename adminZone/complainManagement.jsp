...
<html>
    ...
    <body>
        <form action="#" method="post" >
         ...
         <div id="main" class="table-responsive"style="margin: 0 auto;">
            <form action="#" method="post">
                    <%
                    ...
                    <center>
                        <h2 style="color: navy;">Complain Management</h2>
                        <br /><br /><br />
                        <table class="table table-bordered">
                            ...
                            <tr style="font-size: 16px;">
                                ...
                                <td><a href="adimnCode/deleteComplain.jsp?fid=<%=rs.getInt(1)%>" >Delete</a></td>
                            </tr>
                            <%
                                n++;}
                            %>
