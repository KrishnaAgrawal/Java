...
<html>
    ...
    <body>
        <form action="#" method="post" >
            <div id="warpper" style="background: azure">
            <div id="header" >
                <div id="logo" >
         ...
         <div id="main" class="table-responsive">
            <form action="#" method="post">
                    ...
                    <center>
                        <h2 style="color: navy;">Feedback Management</h2>
                        <br /><br /><br />
                        <table class="table table-bordered">
                            ...
                            <%
                                ...
                                String query = "select id,name,contactno,email,feedback,feedbackdate from feedback";
                            ...
                            <tr style="font-size: 16px;">
                                ...
                                <td><a href="adimnCode/deleteFeedback.jsp?fid=<%=rs.getInt(1)%>" >Delete</a></td>
                            </tr>
                            <%
                                n++;}
                            %>
