...
<html>
    ...
    <body style="background: azure;">
        <form action="#" method="post" >
            <div id="warpper" style="min-height: 900px; ">
            <div id="header" >
                <div id="logo" >
            ...
            <div class="col-sm-12 menu" style="background: skyblue;">
                ...
                <div style="height: 200px; width: 1000px; float: left;">
                    <img src="../Images/admin_1.png" height="200px" width="200px" />
                    <div style="width: 700px;height: 50px; float: right; margin-left: 200px; margin-top: -200px;">
                     <marquee behavior="alternate"><span style="font-size: 40px;color: #ff6600">Welcome Admin!!!</span></marquee>
                    </div>
                </div>
        ...
        <div id="main" >
                    ...
                    <div style="margin-left: -50px;width: 600px; height: 400px;">
                        <a href="userManagement.jsp" style="text-decoration: none; color: white;font-size: 20px;"><input type="button" value="View Users" style="height: 100px; width: 200px; background: skyblue;" /></a>
                        <a href="enquiryManagement.jsp" style="text-decoration: none; color: white;font-size: 20px; margin-left: 125px;"><input type="button" value="View Enquiries" style="height: 100px; width: 200px; background: skyblue;" /></a>
                        <br /><br />
                        <a href="viewUpload.jsp" style="text-decoration: none; color: white;font-size: 20px;"><input type="button" value="View Upload" style="height: 100px; width: 200px; background: skyblue;" /></a>
                        <a href="reviewManagement.jsp" style="text-decoration: none; color: white; margin-left: 125px;font-size: 20px;"><input type="button" value="View review" style="height: 100px; width: 200px; background: skyblue;" /></a>
                    </div>
        </div>
        </div> 
            </form>
