<%-- 
    Document   : ForgetPasswordNewPassword
    Created on : Aug 28, 2017, 1:05:24 AM
    Author     : Aaditya
--%>
...
input[type="button"]{
    ...
    <body>
        <form action="code/ForgetChangePassword.jsp" method="post" >
                ...
                <div id="container1" style="background-image: url('Images/review.jpg'); background-size: cover;background-repeat: no-repeat;">
                    ...
                    <div id="main" style=" margin-left: 400px; ">
                        ...
                        <table>
                                ...
                                <tr>
                                    <td><span style="font-size: 28; font-weight: bold; margin-left: 200px;">OR</span></td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="MakeANewPassword.jsp">
                                            <input type="button" class="txt" value="Make a new password" style="margin-left: 25px; background: lightskyblue; opacity: .8"/>
                                        </a>
                                    </td>
                                </tr>
                        </table>
