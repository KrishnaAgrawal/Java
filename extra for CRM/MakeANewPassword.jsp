<%-- 
    Document   : MakeANewPassword
    Created on : Aug 28, 2017, 1:12:13 AM
    Author     : Aaditya
--%>
...
input[type="button"]{
    ...
    <body>
        ...
        <form action="code/UpdatePassword.jsp" method="post" >
          <%
              if(session.getAttribute("userName")=="" || (session.getAttribute("userName")==null)){
                  response.sendRedirect("ForgetPasswordInfo.jsp");
              }
              else{
          %>
            <div id="warpper" >
         ...
         <div class="col-sm-12 menu" style="background: skyblue; margin-bottom: 10px;">
                ...
                <div id="container1" style="background-image: url('Images/review.jpg'); background-size: cover;background-repeat: no-repeat;">
                    ...
                    <div id="main" style=" margin-left: 400px; ">
                        ...
                        <table style="margin-top: 155px;">
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" id="name" onBlur="validateName()" class="txt" name="password" maxlength="50" required placeholder="Password" style="margin-top: -20px; margin-bottom: 20px;margin-left: 50px;"/>
                                    </td>
                                </tr>
                                <tr><td class="t">Re-enter Password: </td>
                                    <td>
                                        <input type="password" id="number" onblur="validateNumber()" class="txt" min="0" name="rePassword"  maxlength="13" required style="color: black;margin-left: 50px;" placeholder="Re-enter Password"/>
                                    </td>
                                </tr>
                            </table>
                        <table>
                                <tr>
                                    <td><input type="submit" class="txt" value="Update Password" style="margin-left: 100px; background: lightskyblue; opacity: .8"/></td>
                                </tr>
